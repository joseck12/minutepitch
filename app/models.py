...
class User(db.Model):
    ...
    def __repr__(self):
        ...
        class Pitch(db.Model):
            '''
            Creates tab`AAAQQ2Q2QQQQQQ   AAaaaaaaaaaaaaaaaa  AAAQQ2Q2QQQQQQ  self.assert_(boolean expression, 'message')                                                                                                                                                                                                                                                                         flask_sqlalchemy            AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAle to hold user posts
            '''
            id = db.Column(db.Integer, primary_key=True)
